...
def split_county():
    ...
    with open(addr_input, newline='') as csvfile:
        ...
        with open('./rockbridge_original.csv', 'w', newline='') as csvfile_out:
            ...
            for row in addr_reader:
                ...
                if row['MUNICIPALITY'].upper() == 'ROCKBRIDGE COUNTY':
                    new_row = {}
...
def summarize():
    ...
    with open('./rockbridge.csv', newline='') as csvfile: # change me
        addr_reader = csv.DictReader(csvfile)
        streets = {}
        cities = {}
        units = {}
...
def main():
    with open(addr_input, newline='') as csvfile:
        with open('./rockbridge.csv', 'w', newline='') as csvfile_out: # change me
            ...
            for row in addr_reader:
                ...
                # contents are in title case, but we don't take any chances and force
                # an uppercase comparison.
                if row['MUNICIPALITY'].upper() == 'ROCKBRIDGE COUNTY': # change me
